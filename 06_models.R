...
## ----06-models-27, echo = FALSE-------------------------------------
options(digits = old_digits)


## ----06-models-28, fig.height=4, fig.width=10, layout = '1-page'----
...
## ----ch-06-svyyears2, fig.cap='Faceting by education instead.', fig.width = 4, fig.height = 9----
