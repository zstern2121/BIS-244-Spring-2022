...
## ----05-tables-and-labels-1-----------------------------------------
rel_by_region


## ----05-tables-and-labels-2-----------------------------------------
...
## ----05-tables-and-labels-3-----------------------------------------
organdata %>% select(1:6) %>% sample_n(size = 10)      


## ----05-tables-and-labels-4-----------------------------------------
...
## ----05-tables-and-labels-5-----------------------------------------
p <- ggplot(data = organdata,
            mapping = aes(x = country, y = donors))
p + geom_boxplot()      


## ----05-tables-and-labels-6-----------------------------------------
p <- ggplot(data = organdata,
            mapping = aes(x = country, y = donors))
p + geom_boxplot() + coord_flip()      


## ----05-tables-and-labels-7-----------------------------------------
p <- ggplot(data = organdata,
