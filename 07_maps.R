...
## ----07-maps-2, fig.width=4, fig.height=10--------------------------
...
## ----07-maps-5, fig.cap='Coloring the states', out.width="100%", fig.width=6, fig.height=5----
...
## ----07-maps-6, fig.cap='Improving the projection', out.width="100%", fig.width=6, fig.height=5----
...
## ----07-maps-8, fig.cap='Mapping the results', out.width="100%", fig.width=6, fig.height=5----
...
## ----ch-07-firstmap-05, fig.cap='Election 2016 by State', fig.width=8, fig.height=5----
...
## ----07-maps-10, fig.cap='Two versions of Percent Trump by State', out.width="100%", fig.width=6, fig.height=5, fig.show = 'hold'----
...
## ----07-maps-11, fig.cap='Two views of Trump vs Clinton share: a white midpoint, and a Purple America version.', out.width="100%", fig.width=6, fig.height=5, fig.show = "hold"----
...
## ----07-maps-12, fig.cap='A Purple America version of Trump vs Clinton that excludes results from Washington, DC.', out.width="100%", fig.width=6, fig.height=5----
...
## ----ch-07-urchoro1, fig.cap='US population density by county.', out.width="100%", fig.width = 12, fig.height = 8, layout = 'l-screen-inset'----
...
## ----ch-07-urchoro2, fig.cap='Percent Black population by county.', out.width="100%", fig.width = 12, fig.height = 8, , layout = 'l-screen-inset'----
...
## ----ch-07-gunsu, fig.cap='Gun-related suicides by county; Reverse-coded population density by county.', out.width="50%", fig.show="hold", fig.width = 10, fig.height = 7, , layout = 'l-screen-inset'----
...
## ----07-maps-14, fig.cap='Statebins of the election results. We omit DC from the Clinton map to prevent the scale becoming unbalanced.', warning = FALSE, out.width = "100%", fig.show = "hold", fig.margin = TRUE, fig.width = 5, fig.height = 4, tidy = FALSE----
library(statebins)
...
## ----07-maps-15, fig.cap='Manually specifying colors for statebins.', warning = FALSE, out.width = "100%", fig.show = "hold", fig.margin = TRUE, fig.width = 5, fig.height = 4, tidy = FALSE----
...
## ----opiatemap, fig.cap='A small multiple map. States in grey reported too few deaths for a reliable population estimate in that year. States in white reported no data.', out.width="100%", fig.width=8, fig.height=12, fig.show = "hold", fig.fullwidth=TRUE, tidy = FALSE, message = FALSE----
...
## ----07-maps-18, fig.cap='All the states at once.', out.width="100%", fig.width=11, fig.height=8.5----
...
## ----opiatesm, fig.width=8, fig.height=12---------------------------
