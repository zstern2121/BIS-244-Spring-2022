...
## ----08-refine-plots-3, out.width="100%"----------------------------
...
## ----08-refine-plots-4, fig.height=5, fig.width=6-------------------
...
## ----08-refine-plots-5, fig.width=6, fig.height=5-------------------
...
## ----08-refine-plots-6, fig.width=6, fig.height=5-------------------
...
## ----08-refine-plots-7, fig.cap="RColorBrewer's qualitative palettes.", fig.width=4, fig.height=4----
library(RColorBrewer)
display.brewer.all(type = "qual")


## ----08-refine-plots-8, fig.cap='Some available palettes in use.', fig.width=5, fig.height=4, fig.show = "hold"----
...
## ----08-refine-plots-9, fig.cap='Using a custom color palette.', fig.width=8, fig.height=6----
...
## ----08-refine-plots-12, fig.width=5, fig.height=6, fig.show = "hold", fig.cap = "Comparing a default color palette with an approximation of how the same palette appears to people with one of three kinds of color blindness."----
color_comp(color_table)


## ----ch-08-elec-01, fig.cap = "The background layer.", fig.height=4, fig.width=6----
...
## ----ch-08-elec-02, fig.cap = "The second layer.", fig.height=4, fig.width=6----
...
## ----ch-08-elec-03, fig.cap = "Adding guides and labels, and fixing the x-axis scale.", fig.height=4, fig.width=6----
...
## ----ch-08-elec-04, fig.cap='County-level election data from 2016.', , layout = 'l-screen-inset', fig.width=10, fig.height=7----
...
## ----ch-08-themes-01, fig.cap='Economist and WSJ themes.', out.width="50%", fig.width=5.8, fig.height=4.8, fig.show = "hold"----
library(ggthemes)
